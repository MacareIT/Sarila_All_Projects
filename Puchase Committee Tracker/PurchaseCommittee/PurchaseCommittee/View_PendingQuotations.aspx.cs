...
{
    public partial class View_PendingQuotations : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "quotation_view")
            {
                ...
                //DataTable dt = new DataTable();
                //dt = objservice.Get_individualpendingquotations(item_id).Tables[0];
                ...
                Response.Redirect("View_Quotation.aspx?item_id=" + item_id);
            }

            else if(e.CommandName == "add_quotation")
            {
                if (Session["USERTYPE"].ToString() == "purchasehead")
                {
                    ...
                    Response.Redirect("Upload_Quotation.aspx?item_id=" + item_id);
                }
            }
        }
    }
