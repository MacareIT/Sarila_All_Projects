<%@ Page Title="" Language="C#" MasterPageFile="~/accounts.Master" AutoEventWireup="true" CodeBehind="CreditNote_transfer.aspx.cs" Inherits="AccountsApp.CreditNote_transfer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ContentTemplate> 
     <div class="container-fluid">
        <h2 class="mt-4">CREDIT NOTE TRANSFER</h2>
         <div class="container-fluid">
            <br />
             <div class="row">
                <div class="col-md-4">
            ...
            <%--  <div class="row">
                   <div class="col-md-4">
                        Choose Pharmacy
                         <asp:DropDownList ID="ddlbranch" class="form-control" runat="server" BackColor="White" AutoPostBack="True"></asp:DropDownList>
                       </div>
                   <div class="col-md-4">
                       Choose PR_No
                         <asp:DropDownList ID="ddlPr_no" class="form-control" runat="server" BackColor="White" AutoPostBack="True" OnSelectedIndexChanged="ddlPr_no_SelectedIndexChanged"></asp:DropDownList>
                       </div>
                 </div>
             <br />--%>
             <%--<div class="row"> 
                <div class="col-sm-4">   
                    Supplier
                    <asp:TextBox ID="txtSplier" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                 <div class="col-sm-4">   
                    PR Value
                    <asp:TextBox ID="txtPRvalue" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>         
            ...
            <%-- <div class="row">
                 ...
                 <div class="col-md-4">
                     <input type="button" class="btn btn-secondary" id="btnadd"  onserverclick="viewreport"  name="add" value="Save"  runat="server" width="500" />
                 </div>
             </div>--%>
              <div class="row">
               <asp:gridview ID="Gridview1" runat="server" ShowFooter="true" AutoGenerateColumns="false"  OnRowCancelingEdit="Gridview1_RowCancelingEdit" OnRowEditing="Gridview1_RowEditing" OnRowUpdating="Gridview1_RowUpdating" >
                                        <Columns>
                                            <asp:TemplateField HeaderText="ROW_NO" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" >
                                            <ItemTemplate>
                                                <asp:Label ID="Label_no" runat="server" Width="20px" Height="30px" Text='<%#Eval("rownum") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle BackColor="#003366" Font-Bold="True"  ForeColor="White" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="CR_NO" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" Visible="False">
                                            <ItemTemplate>
                                            ...
                                            <ItemTemplate>
                                                 <asp:Label ID="Label3" runat="server" Width="120px" Height="30px" Text='<%#Eval("Branch_name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle BackColor="#003366" Font-Bold="True"  ForeColor="White" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="SUPPLIER" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" >
                                            <ItemTemplate>
                                                <asp:Label ID="Label4" runat="server" Width="130px" Height="30px" Text='<%#Eval("supplier_name") %>'></asp:Label>
                                             </ItemTemplate>
                                            <HeaderStyle BackColor="#003366" Font-Bold="True"  ForeColor="White" />
                                            </asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <asp:CheckBox ID="CheckBox3" runat="server" Checked='<%#(decimal)Eval("Transfered") == 0 ?false : true %>'/>
                                             </EditItemTemplate>
                                            <HeaderStyle BackColor="#003366" Font-Bold="True"  ForeColor="White" />
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="RECEIVED" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" >
                                            <ItemTemplate>
                                                <asp:CheckBox ID="CheckBox4" runat="server" Enabled="False" Checked='<%#(decimal)Eval("received") == 0 ?false : true %>'/>
                                             </ItemTemplate>
                                            
                                            <HeaderStyle BackColor="#003366" Font-Bold="True"  ForeColor="White" />
                                        </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit" ShowHeader="False" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#003366" > 
                <EditItemTemplate> 
