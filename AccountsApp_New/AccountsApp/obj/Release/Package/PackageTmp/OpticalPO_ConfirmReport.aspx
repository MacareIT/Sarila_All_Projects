<%@ Page Title="" Language="C#" MasterPageFile="~/accounts.Master" AutoEventWireup="true" CodeBehind="OpticalPO_ConfirmReport.aspx.cs" Inherits="AccountsApp.OpticalPO_ConfirmReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager runat="server"></asp:ScriptManager>
     <div class="container-fluid">
        <h2 class="mt-4">OPTICAL INVOICE CONFIRMATION REPORT</h2>
         <div class="container-fluid">
            <br />
            <div class="row">
                <div class="col-md-4">
