<%@ Page Title="" Language="C#" MasterPageFile="~/accounts.Master" AutoEventWireup="true" CodeBehind="Supplier_authorized_payments.aspx.cs" Inherits="AccountsApp.Supplier_authorized_payments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager runat="server"></asp:ScriptManager>
     <div class="container-fluid">
        <h2 class="mt-4">Authorization Report</h2>
         <div class="container-fluid">
            <br />
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-sm-2">  
                 ...
                 <div class="col-sm-2">  
                    <br />
                    <input type="button" class="btn btn-secondary" id="btn_download"  onserverclick="download_report"  name="add" value="Download Report"  runat="server" width="500" />
