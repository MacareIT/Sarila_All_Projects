<%@ Page Title="" Language="C#" MasterPageFile="~/accounts.Master" AutoEventWireup="true" CodeBehind="DebitCreditNoteReport.aspx.cs" Inherits="AccountsApp.DebitCreditNoteReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager runat="server"></asp:ScriptManager>
     <div class="container-fluid">
        <h2 class="mt-4">CREDIT NOTE  REPORT</h2>
         <div class="container-fluid">
            <br />
            <div class="row">
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                       Choose Type
                         <asp:DropDownList ID="ddltype" class="form-control" runat="server" BackColor="White">
                             ...
                             <asp:ListItem Value="2">Adjust</asp:ListItem>
                       </asp:DropDownList>
                       </div>
                <div class="col-sm-4">   
                    <br />
