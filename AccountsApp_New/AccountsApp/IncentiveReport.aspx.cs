    ...
    public partial class IncentiveReport : System.Web.UI.Page
    {
        ...
        protected void showreportincentive(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Prm.Values.Add("INCENTIVE REPORT OF : " + ddlbranch.SelectedItem.Text + " BRANCH");
        ...
        protected void showmicrolab(object sender, EventArgs e)
        {
            try
            {
                string header = "";
                ds = new DataSet();
                ds = objService.LoadMicrolab_incentive(txtfrmdt.Text,txtfrmdt.Text);
                ds1 = new DataSet();
                ds1 = objService.IncentiveMicrolabStaffAmount_details(txtfrmdt.Text);
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/MicrolabIncentiveCollection.rdlc");
                ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables[0]);
