...
{
    public partial class SalesProfitability : System.Web.UI.Page
    {
        DataSet ds;
        ...
        //private void fillsuppliers_list()
        //{
        //    ds = new DataSet();
        //    ds = objService.SuppliersList();
        //    ChksuppliersList.DataSource = ds;
        //    ChksuppliersList.DataTextField = "supplier_name";
        //    ChksuppliersList.DataValueField = "supplier_id";
        //    ChksuppliersList.DataBind();
        //}        
        protected void showreport(object sender, EventArgs e)
        {
            ...
            {
                ds = new DataSet();
                ds = objService.MIS_PurchaseRPT(txtfrmdt.Text, txttodate.Text, "sales");
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/PharmaSales.rdlc");
                ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables[0]);
                ReportParameter Prm;
                Prm = new ReportParameter("prm_head1");
                Prm.Values.Add("PHARMACY SALES PROFITABILITY REPORT ");
