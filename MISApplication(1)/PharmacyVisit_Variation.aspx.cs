...
{
    public partial class PharmacyVisit_Variation : System.Web.UI.Page
    {
        DataSet ds;
        ...
        private void fillclinic()
        {
            ...
            ddlbranch.DataBind();
            ddlbranch.Items.Insert(0, new ListItem("---Choose CLINIC--", "0"));
        }

        protected void showreport(object sender, EventArgs e)
        {
            string header = string.Empty; int pharmacy1 = 0, pharmacy2 = 0;
            ...
            {
                pharmacy1 = Convert.ToInt32(ddlpharmacy.SelectedValue);
                pharmacy2 = 0;
            }
            try
            {
                ds = new DataSet();
                ds = objService.PatientsList_NotVisitPharma(txtfrmdt.Text, txttodate.Text, ddlbranch.SelectedValue, pharmacy1.ToString(), pharmacy2.ToString());
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/PharmacynotVisit.rdlc");
                ReportDataSource datasource = new ReportDataSource("DataSet1", ds.Tables[0]);
                ReportParameter Prm;
                Prm = new ReportParameter("prm_head1");
                Prm.Values.Add("LIST OF PATIENTS NOT VISITING PHARMACY OF : " + ddlbranch.SelectedItem.Text + " BRANCH");
