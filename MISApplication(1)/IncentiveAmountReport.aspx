<%@ Page Title="" Language="C#" MasterPageFile="~/Incentive.Master" AutoEventWireup="true" CodeBehind="IncentiveAmountReport.aspx.cs" Inherits="MISApplication.IncentiveAmountReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2 class="mt-4">Incentive Amount Details</h2>
            <div class="container-fluid" style="border-color: #C0C0C0; border-style: double; background-color: #D7EBFF;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        To <asp:TextBox ID="txttodt" class="form-control" runat="server"></asp:TextBox>
                        <ajaxtoolkit:CalendarExtender
                            ID="CalendarExtender1"
                            runat="server"
                            Enabled="True"
                            TargetControlID="txttodt"
                            PopupButtonID="txttodt"
                            Format="dd-MMM-yyyy" PopupPosition="TopRight"></ajaxtoolkit:CalendarExtender>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <br />
                        <input type="button" class="btn btn-primary" id="btnadd" name="add" onserverclick="showreport" value="View Incentive Amount" runat="server" />
                    </div>
