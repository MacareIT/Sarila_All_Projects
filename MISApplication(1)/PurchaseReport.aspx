<%@ Page Title="" Language="C#" MasterPageFile="~/MIS.Master" AutoEventWireup="true" CodeBehind="PurchaseReport.aspx.cs" Inherits="MISApplication.PurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2 class="mt-4">PURCHASE REPORT</h2>
            <div class="container-fluid" style="border-color: #C0C0C0; border-style: double; background-color: #D7EBFF;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <br />
                        <input type="button" class="btn btn-primary" id="btnadd" name="add" value="Show Purchase" onserverclick="showreport" runat="server" />
                    </div>
                     <div class="col-sm-2">
                        <br />
                        <input type="button" class="btn btn-primary" id="Button1" name="add" value="New Purchase" onserverclick="shownewreport" runat="server" />
                    </div>
                </div>
                <br />
            </div>
