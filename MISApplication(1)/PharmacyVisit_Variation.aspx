<%@ Page Title="" Language="C#" MasterPageFile="~/MIS.Master" AutoEventWireup="true" CodeBehind="PharmacyVisit_Variation.aspx.cs" Inherits="MISApplication.PharmacyVisit_Variation" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2 class="mt-4">Pharmacy NonVisit List</h2>
            <div class="container-fluid" style="border-color: #C0C0C0; border-style: double; background-color: #D7EBFF;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        CHOOSE PHARMACY
                         <asp:DropDownList ID="ddlpharmacy" class="form-control" runat="server" BackColor="White"></asp:DropDownList>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <br />
                        <input type="button" class="btn btn-primary" id="btnadd" name="add" onserverclick="showreport" value="Show Report" runat="server" />
                    </div>
                </div>
                <br />
            </div>
