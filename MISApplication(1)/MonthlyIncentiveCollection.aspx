<%@ Page Title="" Language="C#" MasterPageFile="~/Incentive.Master" AutoEventWireup="true" CodeBehind="MonthlyIncentiveCollection.aspx.cs" Inherits="MISApplication.MonthlyIncentiveCollection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2 class="mt-4">Monthly Incentive Details</h2>
            <div class="container-fluid" style="border-color: #C0C0C0; border-style: double; background-color: #D7EBFF;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                     ...
                     <div class="col-sm-2">
                        <br />
                        <input type="button" class="btn btn-primary" id="btnadd" name="add" onserverclick="showemployee" value="View Report" runat="server" />
                    </div>
                </div>
                <br />               
            </div>
