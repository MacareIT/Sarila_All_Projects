<%@ Page Title="" Language="C#" MasterPageFile="~/Incentive.Master" AutoEventWireup="true" CodeBehind="AddPercent.aspx.cs" Inherits="MISApplication.AddPercent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2 class="mt-4">Customize Incentive</h2>
            <div class="container-fluid" style="border-color: #C0C0C0; border-style: double;background-color: #D7EBFF;">
                <div class ="row">
                    ...
                    <div class="col-sm-5">  Choose Department
                ...
                <br />
                 <div class ="row">
                     ...
                     <div class="col-sm-5">
                          Taget Collection
                          <asp:TextBox ID="txttargetcollection" class="form-control" runat="server"></asp:TextBox>
                       </div><br />
                      <div class="col-sm-2"><br />
                  <asp:RequiredFieldValidator ControlToValidate="txttargetcollection" ErrorMessage="*" ForeColor="Red" ID="RequiredFieldValidator4" runat="server"></asp:RequiredFieldValidator>
                          </div>
                 </div><br />
                <div class ="row">
                      <div class="col-sm-2">Upto 100%
