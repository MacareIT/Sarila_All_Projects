...
{
    public partial class ChargeRpt_View : System.Web.UI.Page
    {
        ...
        public void Load_staff()
        {
            ...
            dtuser = objService.Select_ChargeRpt_EnteredStaff(Convert.ToInt32(cmbBranch.SelectedValue)).Tables[0];
