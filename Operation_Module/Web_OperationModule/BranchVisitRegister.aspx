<%@ Page Title="" Language="C#" MasterPageFile="~/Users_master.Master" AutoEventWireup="true" CodeBehind="BranchVisitRegister.aspx.cs" Inherits="Web_OperationModule.BranchVisitRegister" %>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6" style="width:980px;">
                        <div class="bg-light rounded h-100 p-4" style="height:500px;">
                            ...
                            <br /><br />
                            <%--<asp:Button ID="Btn_Submit1" class="btn btn-primary" runat="server" Text="Confirm" BackColor="#1C5E55" OnClick="Btn_Submit_Click1" />--%>
