<%@ Page Title="" Language="C#" MasterPageFile="~/Users_master.Master" AutoEventWireup="true" CodeBehind="InventoryStatusReg.aspx.cs" Inherits="Web_OperationModule.InventoryStatusReg" %>
                                ...
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Physical Stock" ItemStyle-Width="80">
                                           <ItemTemplate>
                                                   <asp:TextBox ID="txt_PStk" runat="server" Width="70" Text='<%# Eval("Phy_Stk") %>' MaxLength="10" class='allow_decimal'>
                                                   </asp:TextBox>
                                               <%--<Triggers>
