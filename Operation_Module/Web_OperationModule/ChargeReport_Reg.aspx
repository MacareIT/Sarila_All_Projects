<%@ Page Title="" Language="C#" MasterPageFile="~/Users_master.Master" AutoEventWireup="true" CodeBehind="ChargeReport_Reg.aspx.cs" Inherits="Web_OperationModule.ChargeReport_Reg" %>
                    ...
                    <div class="col-sm-12 col-xl-6" style="width:980px;">
                        ...
                        <label id="Label1" for="exampleInputEmail1" class="form-label" runat="server">CASH POSITION STATUS</label>
                            ...
                            <ContentTemplate>
                                ...
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Remarks" ItemStyle-Width="100">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_Remarks" runat="server" Width="70" Text='<%# Eval("Remarks") %>' MaxLength="10" OnKeyPress=" return isNumberKey(this);" >
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="100px" />
                                       </asp:TemplateField>
                                ...
                                <asp:GridView ID="GridMissAsset" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" BorderStyle="Solid" OnRowCreated="GridMissAsset_RowCreated" >
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
        ...
        <asp:TemplateField>  
            <ItemTemplate>  
                <asp:LinkButton ID="LinkButton1" runat="server"   
                                ...
                                <asp:GridView ID="GridDamageAsset" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid">
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       <asp:TemplateField HeaderText="Asset ID" ItemStyle-Width="250">
                                           <ItemTemplate>
                                ...
                                <asp:GridView ID="GridExcessAsset" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid">
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       <asp:TemplateField HeaderText="Asset ID" ItemStyle-Width="250">
                                           <ItemTemplate>
                                ...
                                <asp:GridView ID="GridBankRec" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid">
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       <asp:TemplateField HeaderText="Bank Name" ItemStyle-Width="150">
                                           <ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="Reconciliation Date" ItemStyle-Width="250">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_ReconDate" runat="server" Width="250" Text='<%# Eval("Status") %>' >
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="250px" />
                                       </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Difference" ItemStyle-Width="200">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_Diff" runat="server" Width="200" Text='<%# Eval("Diff") %>'>
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="200px" />
                                       </asp:TemplateField>
                                ...
                                <label id="Label9" for="exampleInputEmail1" class="form-label" runat="server">DOCTORS AVAILABILITY</label>
                                <asp:GridView ID="GridDr" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid">
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Department" ItemStyle-Width="250">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_dept" runat="server" Width="250" Text='<%# Eval("Status") %>' >
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="250px" />
                                       </asp:TemplateField>
                                ...
                                <label id="Label10" for="exampleInputEmail1" class="form-label" runat="server">VERTICAL WISE STATUS</label>
                                ...
                                <%--<label id="Label11" for="exampleInputEmail1" class="form-label" runat="server">INVENTORY VERIFICATION</label>--%>
                                <%--<asp:GridView ID="GridInventory" runat="server"  Width="880px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid">
                                <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                       <asp:TemplateField HeaderText="Inventory" ItemStyle-Width="150">
                                           <ItemTemplate>
                                               <asp:Label ID="lbl_Inventory" runat="server" Text='<%# Eval("Name") %>' Width="150"></asp:Label>
                                           </ItemTemplate>
                                           <ItemStyle Width="150px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Short" ItemStyle-Width="250">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_Short" runat="server" Width="250" Text='<%# Eval("Status") %>' >
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="250px" />
                                       </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Excess" ItemStyle-Width="200">
                                           <ItemTemplate>
                                               <asp:TextBox ID="txt_Excess" runat="server" Width="200" Text='<%# Eval("Diff") %>'>
                                               </asp:TextBox>
                                           </ItemTemplate>
                                           <ItemStyle Width="200px" />
                                       </asp:TemplateField>
                            ...
                            <br /><br />
                            <asp:Button ID="Btn_Submit1" class="btn btn-primary" runat="server" Text="Confirm" BackColor="#1C5E55" OnClick="Btn_Submit1_Click"/>
