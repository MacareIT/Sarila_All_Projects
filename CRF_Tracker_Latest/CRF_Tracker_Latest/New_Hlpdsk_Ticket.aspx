<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_Hlpdsk_Ticket.aspx.cs" Inherits="CRF_Tracker_Latest.New_Hlpdsk_Ticket" %>
                 ...
                 <% if (Session["USERTYPE"].ToString() == "cfo")
                    ...
                    <li>
                     ...
                     <li class="active-link">
                        <a href="New_Hlpdsk_Ticket.aspx"><i class="fa fa-edit "></i>Add Ticket</a>
                    </li>
                    <% } %>
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                 ...
                 <div class="row">
                    <div class="col-lg-8 col-md-4">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddl_type" runat="server" CssClass="form-control" required="required" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddl_type_SelectedIndexChanged">
                                                <asp:ListItem>--Select--</asp:ListItem>
                                                <asp:ListItem>CRF Based</asp:ListItem>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-4">
                        <div class="form-group">
                            <label>CRF Description</label>
                            <%--<asp:DropDownList ID="ddl_crf" runat="server" CssClass="form-control" required="required" Width="250px">
                            </asp:DropDownList>--%>
                            <asp:TextBox ID="txt_crf" runat="server" CssClass="form-control" required="required" ></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txt_issue" runat="server" TextMode="MultiLine" Height="120px" CssClass="form-control" required="required"></asp:TextBox>
                 ...
                 <div class="row">
                     <div class="col-lg-4 col-md-4" id="appear" runat="server">
                            <div class="form-group">
                                            ...
                                            &nbsp; <asp:DropDownList ID="ddl_emp" runat="server" CssClass="form-control"></asp:DropDownList>  
                                        </div>   
                        </div>
                </div>
