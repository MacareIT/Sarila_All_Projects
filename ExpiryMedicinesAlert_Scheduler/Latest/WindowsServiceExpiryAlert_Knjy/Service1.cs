...
namespace WindowsServiceExpiryAlert_Knjy
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            DataTable dtktr = objService.Get_ExpiryMedicines_Kanjany().Tables[0];
            ...
            {
                dtktr.TableName = "ExpiringMedicines_Kanjany";
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    using (MemoryStream memoryStream = new MemoryStream())
                    {
                        ...
                        memoryStream.Close();
                        MailMsg.Attachments.Add(new Attachment(new MemoryStream(bytes), "ExpiringMedicines_Kanjany.xlsx"));
                    }
                }
            }
