...
namespace WindowsServiceExpiryAlert_Cherpu
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            DataTable dtktr = objService.Get_ExpiryMedicines_Cherpu().Tables[0];
            ...
            {
                dtktr.TableName = "ExpiringMedicines_Cherpu";
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    using (MemoryStream memoryStream = new MemoryStream())
                    {
                        ...
                        memoryStream.Close();
                        MailMsg.Attachments.Add(new Attachment(new MemoryStream(bytes), "ExpiringMedicines_Cherpu.xlsx"));
                    }
                }
            }
