...
namespace WindowsServiceExpiryAlert_WSale
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            DataTable dtktr = objService.Get_ExpiryMedicines_Wholesale().Tables[0];
            ...
            if (dtktr.Rows.Count > 0)
            {
                dtktr.TableName = "ExpiringMedicines_Kattoor";
                using (XLWorkbook wb = new XLWorkbook())
                {
                    //Add the DataTable as Excel Worksheet.
                    wb.Worksheets.Add(dtktr);
                    ...
                    using (MemoryStream memoryStream = new MemoryStream())
                    {
                        ...
                        memoryStream.Close();
                        MailMsg.Attachments.Add(new Attachment(new MemoryStream(bytes), "ExpiringMedicines_Kattoor.xlsx"));
                    }
                }
            }
